...
export default {
  ...
  methods: {
     ...
     */
    onSearchSubmit(v) {
      this.searchForm = lodash.cloneDeep(v);
    ...
    searchBarWrapperRender() {
      ...
      const setSerrchFormAttrs = {
        ...
        buttonGroupRender: (
          ...
          return [
            <el-button on-click={submitFunc}>查询</el-button>,
            <el-button on-click={this.resetSearch}>清空</el-button>
          ];
        },
    ...
    return (
      <div class="base-list">
        {this.haveSearchForm ? (
          ...
          >
            <el-collapse-item name="search-bar">
              <div>
